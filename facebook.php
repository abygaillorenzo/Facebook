...
<body>
    ...
    <form action="facebookvalidation.php" method="GET">
 
<div class="Login">

	<table><tr>
			<td>Email or Phone<br><input type="text" name="Email">&emsp;</td>
			<td><br>Password<br><input type="text" name="Password"><br><div class="Forgot">Forgot account?&emsp;</div></td>
			<td><br>&emsp;<button class="button"><b>Log In</b></button>&emsp; &emsp;</td>
	</tr></table></div>
<div class="fb"><br><h1> &emsp; &nbsp; &emsp; &emsp;<b>facebook</b></h1></div>
<div class="text"><h3>Sign Up</h3></div><div class="text1">It's quick and easy</div>

<div id="text3"><h2>&emsp; &nbsp; &emsp; &emsp;Connect with friends and the<br>&emsp; &nbsp; &emsp; &emsp;world around you on Facebook.</h2></div><br>
<br><div id="icon1"><img src="https://icons-for-free.com/iconfiles/png/512/newsfeed+newspaper+read+relax+icon-1320185244456629738.png"><br><b style="font-size: 20px;">&emsp;See photos and Updates</b> from friends and News Feed<br><br><br><div id="icon2"><br><img src="https://cdn4.iconfinder.com/data/icons/health-bold-line-2/48/75-512.png"><br><b style="font-size: 20px;">&emsp;Share what's new</b> in your life on your Timeline<br><br><br><br><div id="icon3"><img src="https://images-na.ssl-images-amazon.com/images/I/31KSwkqxXoL.png"><br><b style="font-size: 20px;">&emsp;Find more</b> of what you're looking for with Facebook search</div></div></div>

<div class="info">
	<table><tr>
			<td><div class="input"><input type="name" name="firstname" placeholder="First name" size="25" pattern="[A-Za-z\S]{1,26}"title="Only Character from [A-Z][a-z] Uppercase or Lowercase">&nbsp;</div></td>
			<td><div class="input"><input type="name" name="lastname" placeholder="Last name" size="24" pattern="[A-Za-z]{1,26}"title="Only Character from [A-Z][a-z] Uppercase or Lowercase"></div></td>
		</tr><table>
		<tr><td><div class="input"><input type="name" name="mobile" placeholder="Mobile number or email" size="58" pattern="[0-9]{11}"title="Only Number from 0-9 / 11 digit Only"></div></td>
		</tr></table>
		<table><tr>
		<td><div class="input"><input type="password" name="pass" placeholder="New password" size="58" required></div></td>
		</tr></table>
		<table><tr>
		<td><div class="input"><input type="password" name="conpass" placeholder="Confirm password" size="58"required></div></td>
		</tr></table>
	</table>
    <div class="P"><b>&nbsp;Birthday</b></div>
	<tr><td>
	<div id="head1">
    <select name='birthdayA' required>
    <option value=''>Month</option><option value='Janaury'>Janaury</option><option value='February'>February</option><option value='March'>March</option>
	...
	<td><div id="head3">
    <select name='birthdayB' required>
    <option value=''>Day</option><option value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option>       
    ...
    <option value='25'>26</option><option value='26'>26</option><option value='27'>27</option><option value='28'>28</option><option value='29'>29</option>
    <option value='30'>30</option> <option value='31'>31</option>
    </select></div></td>
	<td><div id="header2">
    <select name="birthdayC"required>
    <option value=''>Year</option>
    <option value="20120">2020</option><option value="2019">2019</option><option value="2018">2018</option><option value="2017">2017</option>
...
<tr><td><div class="P"><b>&nbsp;Gender<br></b><div></td>
	<td>&emsp; &emsp;&emsp; &emsp;<div class="G"><input type="radio" name="gender" value="Female" required> Female&nbsp;&nbsp;<input type="radio" name="gender" value="Male" required>&nbsp;&nbsp;Male&nbsp;&nbsp;<input type="radio" name="gender" value="Custom" required>&nbsp;&nbsp;Custom&nbsp;&nbsp;</div></td></tr>
<br><tr>
	<div id="footer">By clicking Sign Up, you agree to our Terms, Data Policy and <br>Cookies Policy. You may receive SMS Notifications from us and <br>can opt out any time.</div></tr>
<br><tr>
    <button id="signin">Sign Up</button></tr>
<br><br><tr>
    <div id="footer1">Create a Page for a celebrity, band or business.</div></tr>
    ...
    #footer1{
      ...
      <?php
       ...
       $connect + mysqli_connect($servername, $username, $password, $databasename);
        ...
        $insert = "INSERT INTO tblfacebook(firstname, lastname, email, password, birthdate, gender)VALUES('$firstname', 'lastname', '$email', '$password', '$birthdate', '$gender')";
